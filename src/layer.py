...
class GNN_Layer(Module):
    ...
    def __init__(self, scatter_type: str, dim_in: int, dim_edge: int, dim_M: int, dim_U: int, dim_out: int, n_M_layers: int, n_U_layers: int, m_nonlin:str="relu", u_nonlin:str="relu") -> None:
        super().__init__()
